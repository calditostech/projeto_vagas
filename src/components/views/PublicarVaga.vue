    ...
    <div class="container py-4">
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="form-control">Por exemplo: Programador Javascript e Vue.JS</div>
            </div>
        </div>
        ...
        <div class="row mt-3">
            <div class="col">
                ...
                <div class="form-control">Informe os detalhes da vaga.</div>
            </div>
        </div>
...
export default {
    ...
    methods: {
       salvarVaga() {
          ...
          dataPublicacao = dataAtual.toISOString()
